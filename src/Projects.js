        ...
        return (
            <div className="projects-container" id="projects">
                ...
                <div className="project-three">
                    <a href="https://floating-cliffs-04957.herokuapp.com/index.html" target="_blank" rel="noopener noreferrer"><img src="https://github.com/ajsaule/The-Happy-Path/blob/master/images/final_product_1.png?raw=true" alt="project-three-design" srcset=""/>
                    </a>
                ...
                <div className="project-two">
                    <a href="https://boiling-temple-92123.herokuapp.com/" target="_blank" rel="noopener noreferrer"><img src="https://github.com/erineagloria/project_2/raw/master/Loopd%20Final%20Design.png?raw=true" alt="project-two-design" srcset=""/>
                    </a>
                ...
                <div className="project-one">
                    <a href="https://erineagloria.github.io/tic-tac-toe/" target="_blank" rel="noopener noreferrer"><img src="https://github.com/erineagloria/tic-tac-toe/blob/master/Tic-Tac-Toe.png?raw=true" alt="project-one-design" srcset=""/>
                    </a>
